...
export default class Movement {
    constructor() {
        ...
        this.forwardPaperPlane = VueSelector('BottomButton').find('.fa.fa-paper-plane.fa-2x.fa-1x.fa');
        this.forwardItemPaperPlane = Selector('.icon').nth(43).find('.fas.m-r-5.fa.fa-paper-plane');
        this.backwardPaperPlane = VueSelector('BottomButton').find('[class^="fa fa-paper-plane fa-flip-horizontal fa-2x fa-1x f"]');
